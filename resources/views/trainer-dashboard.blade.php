...
@php
    ...
    // ✅ forms NEVER show unless user_id exists
...
@endif
    ...
    <div id="profileBox" class="card hidden">
        ...
        <div class="profile-box">
            <div class="welcome-left" style="margin-bottom:12px;">
                <img src="{{ $trainerPhoto }}" class="avatar" alt="Trainer">
                <div>
                    <h2 style="font-size:16px;margin:0">{{ $trainer->name }}</h2>
    ...
    {{-- ✅ Plans ONLY if trainee selected --}}
    @if($trainee)

        {{-- ✅ إذا ما في type، ما نعرض فورمز --}}
        @if(!$selectedType)
        ...
        <div class="plans-stack" style="margin-top:14px;">
                ...
                <form method="POST" action="{{ route('trainer.addWorkout') }}" class="form">
                    ...
                    @if(isset($workoutTemplates) && $workoutTemplates->count())
                        <div class="form-group">
                            ...
                            <select class="form-control" onchange="loadWorkoutTemplateFromSelect(this)">
                    ...
                    <div id="workout-rows" class="rows-wrap">
                        <div class="workout-row">
                            ...
                            <select name="muscle[]" required>
                                ...
                                @foreach(['Chest','Back','Shoulders','Legs','Abs','Biceps','Triceps'] as $muscle)
                                    <option value="{{ $muscle }}" title="{{ $muscle }}">{{ $muscle }}</option>
                                @endforeach
                            </select>
            ...
            {{-- ✅ Nutrition (ONLY when type=nutrition) --}}
                ...
                <form method="POST" action="{{ route('trainer.addNutrition') }}" class="form">
                    ...
                    @if(isset($nutritionTemplates) && $nutritionTemplates->count())
                        <div class="form-group">
                            ...
                            <select class="form-control" onchange="loadNutritionTemplateFromSelect(this)">
                                <option value="">-- Select Template --</option>
                    ...
                    <div id="nutrition-rows" class="rows-wrap">
                    ...
                    <button type="button" class="add-row-btn" onclick="addNutritionRow()">
